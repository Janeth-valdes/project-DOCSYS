...
=======
  <div class="box">
    <form action="{{ route('login1') }}" method="post">
      @csrf
      <div align="center">
        <FONT COLOR="GREEN" style="font-weight: 999;" SIZE="6" align="center"> DOCSYS </FONT>
      </div>


      <div>
        <i class="fa-solid fa-user"></i> <input name="usuario" id="contraseña" type="text" class="form-control"
          placeholder="Ususario" autofocus>
        @error('usuario')
>>>>>>> 1db8b5d0c0ee68dd69cc3953ae3e17df68007473
      ...
      <br>
      <div>
        <i class='fas fa-key'></i> <input type="password" class="form-control" name="contrasena"
