...
<div class="container" align="center" style="width: 700px;">
  <div class="alert alert-danger" role="alert">
    <p>
    <h4 class="alert-heading">¡No se encuentra creada la reunion de calidad!</h4>
    </p>
    <hr>
...
<div class="container">
  <form action="{{route('actualizarmin')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group row">
      <label class="col-sm-2 col-form-label">Participantes:</label>
      <div class="col-sm-10">
        <select class="form-control" id="select1" name="participantes[]" multiple data-live-search="true" title="Seleccionar">
